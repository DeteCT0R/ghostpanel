...
namespace GhostPanel.Rcon.Steam.Packets
{
    ...
    class SteamRconPacket
    {
        ...
        public SteamRconPacket(int id, PacketType type, string body)
        {
            Id = id;
            Type = type;
            Body = body;
        ...
        internal static SteamRconPacket FromBytes(byte[] buffer)
        {
